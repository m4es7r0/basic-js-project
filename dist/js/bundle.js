...
function calc() {
  ...
  if (localStorage.getItem('sex')) sex = localStorage.getItem('sex');else sex = 'female', localStorage.setItem('sex', 'female');
  if (localStorage.getItem('ratio')) ratio = localStorage.getItem('ratio');else ratio = '1.375', localStorage.setItem('ratio', '1.375');
  ...
  function calcTotal() {
    ...
    if (sex === 'female') {
      result.innerHTML = "<span>".concat(Math.round((447.6 + 9.2 * weight + 3.1 * height - 4.3 * age) * ratio), "</span> \u043A\u043A\u0430\u043B");
    } else {
      result.innerHTML = "<span>".concat(Math.round((88.36 + 13.4 * weight + 4.8 * height - 5.7 * age) * ratio), "</span> \u043A\u043A\u0430\u043B");
    }
  }
...
function cards() {
  ...
  var Card = /*#__PURE__*/function () {
    function Card(parentSelector, img, alt, title, text, price, currency) {
  ...
  (0,_services_services__WEBPACK_IMPORTED_MODULE_0__.getCardInfo)(Card);
}
...
function forms(formSelector) {
  ...
  function bindPostData(form) {
    form.addEventListener('submit', function (e) {
      ...
      var formDataObj = Object.fromEntries(formData.entries(formData));
      (0,_services_services__WEBPACK_IMPORTED_MODULE_0__.postData)(form, formDataObj);
    });
  }
}
...
function tabs() {
  ...
  function hideTabContent() {
    ...
    tabs.forEach(function (tab) {
      return tab.classList.remove('tabheader__item_active');
    });
  }
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "getCardInfo": () => (/* binding */ getCardInfo),
...
var postData = function postData(form, formDataObj) {
  var messages = {
  ...
  function showThanksModal(messages) {
    ...
    (0,_modules_modal__WEBPACK_IMPORTED_MODULE_1__.openModal)('.modal');
    var thanksModal = document.createElement('div');
    thanksModal.classList.add('modal__dialog');
    thanksModal.innerHTML = "\n            <div class=\"modal__content\">\n                <div class=\"modal__close\" data-closeModal >&times;</div>\n                <div class=\"modal__title\">".concat(messages, "</div>\n            </div>\n        ");
    document.querySelector('.modal').append(thanksModal);
    setTimeout(function () {
      thanksModal.remove();
      prevModalDialog.classList.toggle('hide');
      (0,_modules_modal__WEBPACK_IMPORTED_MODULE_1__.closeModal)('.modal');
    }, 2000);
  }

  axios__WEBPACK_IMPORTED_MODULE_0___default().post('http://localhost:3000/requests', formDataObj).then(function (data) {
...
var getCardInfo = function getCardInfo(classCard) {
  axios__WEBPACK_IMPORTED_MODULE_0___default().get('http://localhost:3000/menu').then(function (res) {
...
document.addEventListener('DOMContentLoaded', function () {
  (0,_modules_tabs__WEBPACK_IMPORTED_MODULE_1__.tabs)();
  (0,_modules_modal__WEBPACK_IMPORTED_MODULE_2__.modal)('.modal', '[data-modal]');
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_3__.timer)();
  (0,_modules_calc__WEBPACK_IMPORTED_MODULE_4__.calc)();
  (0,_modules_cards__WEBPACK_IMPORTED_MODULE_5__.cards)();
  (0,_modules_forms__WEBPACK_IMPORTED_MODULE_6__.forms)('form');
